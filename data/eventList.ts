...
export const eventsList: EventList[] = [
...

    {
        ...
        rules: [
            ...
            "Bring your own laptop , College Wifi will be provided.",
            ...
            "The participant should be present at the venue during event and no participating from remote location is allowed",
            "The complete reel must be done in the venue itself ,and the individual should be present till the very end of event",
            "Late submissions will not be accepted under any circumstances",
            "Misbehavior, disruption, plagiarism, or unfair practices may result in immediate disqualification",
        ],
    },
    {
        eventNo: 35,
    ...
    },
    {
        ...
        minParticipants: 1,
        rules: [
            "All the team members should join the room within 5-10mins after the id pass is given (any team failing to join within the given time will miss the particular match).",
            "All team members should open your game from appstore or playstore and show the recent apps and should do SCREEN RECORDING until the flight.",
            "Team leaders should take your teams SCREENSHOT after each match ends and upload it in the group with respective team names and number.",
            "Strictly no use of any kind of hacks/bugs/glitches/third party apps. (any team found will be disqualified)",
            "No teaming up with other teams.",
            "If the room crashes the match will be hosted once again with new id and pass.",
            "If any team member found doubtful about their respective gameplay will be asked to provide pov failing to do so will lead to team disqualification",
            "No jumping of slots is allowed.",
            "Only registered players are allowed to participate (no last-minute substitutions without permission).",
            "All participants must carry their own devices, earphones.",
            "Team names must be appropriate and non-offensive.",
            "Matches will be conducted in Custom Rooms.",
            "Format: 3 Matches (Classic Mode).",
            "Maps can include: 1. Erangel 2. Miramar",
            "Match 1 → Erangel",
            "Match 2 → Miramar",
            "Match 3 → Erangel",
            "Organizers are not responsible for lag, ping issues, or disconnections.",
            "If a player disconnects, the match will continue.",
            "Room ID and password will be shared before each match.",
            "Maximum 4 members should be there in a team.",
    ...
    },
    {
        ...
        rules: [
            ...
            "Participation is strictly offline",
            "A student ID will be given on the spot",
            "Redesign it with a creative concept",
            "Focus on visual appeal and uniqueness",
            "Ensure originality (no direct copying)",
            "No offensive, explicit, or harmful content",
            "Tools Allowed : Canva, Figma, Photoshop, Illustrator, or any design tool",
            "Bring your own laptop , Wifi will be provided",
            "Final design must be presented with theme and idea explanation",
    ...
    },
    {
        ...
        rules: [
            ...
            "Participation is strictly offline (venue presence required)",
            "Redesign the given product/experience",
            "Create a new and innovative design solution",
            "Produce ONE advertisement output based on your redesign",
            "Bring your own laptop (College WiFi will be provided)",
            "Allowed tools: Canva, Figma, Adobe, or any design tools",
            "Basic AI tools allowed for ideas/assets (output must remain original)",
            "Submit both: Final design output and One advertisement (Ad) output",
            "Submission format: MP4 file",
            "Entire work must be completed within the 60-minute timeframe",
            "Participants must stay at the venue until the event ends",
            "No copying of existing designs/templates",
            "Content must be original, creative, and unique. No offensive, explicit, or harmful content",
            "Plagiarism or copied work will lead to disqualification. Misbehavior or unfair practices will result in removal. Leaving before completion will lead to disqualification",
        ],
    },
    {
        eventNo: 40,
        ...
        minParticipants: 2,
        rules: [
            "Participation is in teams (as specified by the organizers).",
            "Total event duration: 90 minutes.",
            "The target website will be displayed for the first 20 minutes only.",
            "After the viewing phase, the website will be hidden.",
            "Participants must rebuild the website using only their memory and notes.",
            "Taking notes is allowed; however, screenshots, screen recordings, or any form of digital capture are strictly prohibited.",
            "Participants must bring their own laptops.",
            "College Wi-Fi will be provided for the duration of the event.",
            "Use of AI tools, code generators, or external references (including internet browsing for design replication) is strictly prohibited.",
            "Participants must develop a working frontend that closely matches the original website.",
            "Final submission can be done via ZIP file, GitHub repository, or live demo.",
            "Judging criteria include: Accuracy of design and layout, UI/UX quality, Responsiveness across devices, Code quality and structure.",
            "Limit for registration is 30 teams.",
        ],
    },
    {
        eventNo: 41,
        ...
        rules: [
            ...
            "If Event does not meet Minimum requirement of Teams event will not occur",
        ],
    },
    ...
    },
    {
        ...
        minParticipants: 1,
        rules: [
            "Teams must consist of 1–2 members; no changes are allowed after registration.",
            "A participant may be part of only one team; no duplicate rosters.",
            "Sharing, lending, or using another participant's login credentials is strictly prohibited.",
            "Each member must use their own personal laptop; shared or venue machines are not permitted.",
            "Valid college IDs must be carried at all times, and venue guidelines must be followed.",
            "Only one active login session per team is permitted on the platform at any time.",
            "Ethical hacking practices and respectful conduct toward all attendees are mandatory.",
            "Any misconduct, impersonation, or misuse of resources will result in immediate disqualification.",
            "Only official CTF platform challenges may be attempted; no probing of external systems.",
            "DoS/DDoS, brute-force attacks, and actions disrupting platform availability are prohibited.",
            "Unintended infrastructure vulnerabilities must be reported immediately, not exploited.",
            "Sharing flags, solutions, hints, or methodologies with other teams is strictly prohibited.",
            "Collaboration is restricted to within the registered team; no cross-team coordination.",
            "Automation abuse and scripted mass-solving to gain an unfair advantage are forbidden.",
            "Points are awarded based on difficulty; dynamic scoring may decrease values as solves increase.",
            "Flags must be submitted in the correct format (e.g., CTF{...}) to earn points.",
            "The leaderboard updates in real-time; ties are broken by the earliest cumulative submission time.",
            "Only designated organizers may issue official clarifications, amendments, or rulings.",
