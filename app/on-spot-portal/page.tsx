...
export default function OnSpotPortalPage() {
  ...
  const day1FormUrl = "https://forms.gle/48B5xidyvJTxdjz68";
          ...
          <div className="bg-card border border-blue-200 rounded-2xl p-6 flex flex-col md:flex-row items-center gap-6 hover:shadow-lg transition-shadow">
            <div className="flex-1 flex flex-col gap-2">
              <h2 className="text-xl font-bold text-foreground">
                INTERACT 2026 – On Spot Registration - DAY - 03
              </h2>
              <p className="text-sm text-muted-foreground">
                Scan the QR code or click the button to open the registration form for Day 3.
              </p>
              <a
                href={day1FormUrl}
                target="_blank"
