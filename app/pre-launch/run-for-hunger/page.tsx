        ...
        <div className="min-h-screen bg-gat-off-white text-gat-charcoal font-body flex flex-col items-center pt-32 pb-24 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10 max-w-6xl flex flex-col items-center">
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                            ...
                            <div className="rounded-[2rem] border-2 border-gat-blue/10 bg-white overflow-hidden flex flex-col p-8 relative hover:border-gat-blue/40 shadow-card hover:shadow-card-hover transition-all">
                                <div className="absolute top-0 right-0 bg-gat-blue text-white text-[10px] sm:text-xs font-black px-4 py-2 rounded-bl-2xl tracking-widest ">
                                    COMPETITIVE
                                </div>
                                <h3 className="font-heading text-3xl font-black mb-1 text-gat-midnight uppercase">5K Run</h3>
                                <p className="text-[10px] font-bold text-gat-blue uppercase tracking-widest mb-4">NCC / NSS / SCHOOL STUDENTS</p>
                                <p className="text-gat-steel font-medium mb-8 flex-grow">Special discounted rate for students and members of NCC/NSS squads.</p>
                                ...
                                <div className="mt-auto">
                                    ...
                                    <Link
                                        href="https://docs.google.com/forms/d/e/1FAIpQLScjm-bdzVT4X0vOurs1wjTbH9kBDBKbW-mCv4mt15trMAJAuQ/viewform?usp=sharing&ouid=111257223821631545325"
                                        target="_blank"
                            ...
                            <div className="rounded-[2rem] border-2 border-gat-blue/10 bg-white overflow-hidden flex flex-col p-8 relative hover:border-gat-blue/40 shadow-card hover:shadow-card-hover transition-all">
                                ...
                                <h3 className="font-heading text-3xl font-black mb-1 text-gat-midnight uppercase">5K Run</h3>
                                <p className="text-[10px] font-bold text-gat-steel uppercase tracking-widest mb-4">GENERAL PUBLIC</p>
                                <p className="text-gat-steel font-medium mb-8 flex-grow">Open for all ages. Above 30+ and Below 30+ categories included.</p>
                            ...
                            <div className="rounded-[2rem] border-2 border-gat-blue/10 bg-white overflow-hidden flex flex-col p-8 relative hover:border-gat-navy/40 shadow-card hover:shadow-navy transition-all">
                                ...
                                <h3 className="font-heading text-3xl font-black mb-1 text-gat-midnight uppercase">3K Run</h3>
                                <p className="text-[10px] font-bold text-gat-steel uppercase tracking-widest mb-4">FUN RUN</p>
                                ...
                                <div className="mt-auto">
                                    ...
                                    <Link
                                        href="https://docs.google.com/forms/d/e/1FAIpQLSdpZIg2e0wtu5ZMIw9W3OXGRe0K2-84o6Ay0hP5P8d4KLjFTA/viewform?usp=sharing&ouid=111257223821631545325"
                                        target="_blank"
                ...
                <div className="w-full mt-16">
                    <div className="bg-white border-2 border-gat-blue/10 rounded-[3rem] p-8 md:p-12 shadow-card flex flex-col lg:flex-row items-center justify-between gap-12 hover:border-gat-blue/30 transition-all relative overflow-hidden backdrop-blur-sm">
                        <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-gat-blue/5 rounded-full blur-3xl pointer-events-none" />

                        <div className="flex items-center gap-6 relative z-10">
                            <div className="w-20 h-20 rounded-[2rem] bg-gat-blue text-white flex items-center justify-center shadow-blue flex-shrink-0 animate-float">
                                <Activity className="w-10 h-10" />
                            </div>
                            <div>
                                <h3 className="font-heading text-1xl md:text-2xl font-black text-gat-midnight uppercase leading-none mb-2">Need Assistance?</h3>
                                <p className="text-gat-steel font-medium text-sm">Our event coordinators are here to help you through every step.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-6 w-full lg:w-auto relative z-10">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full lg:w-auto">
                                ...
                                <div className="flex flex-col bg-gat-off-white/50 p-6 rounded-2xl border border-gat-blue/5 group hover:bg-white hover:border-gat-blue/20 transition-all">
                                    <span className="text-xl font-black text-gat-midnight font-heading tracking-tight group-hover:text-gat-blue transition-colors">+91 97394 65800</span>
                                    <span className="text-sm font-bold text-gat-steel mt-1 uppercase">Kausthubha L</span>
                                </div>
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full lg:w-auto">
                                <div className="flex flex-col bg-gat-off-white/50 p-6 rounded-2xl border border-gat-blue/5 group hover:bg-white hover:border-gat-blue/20 transition-all">
